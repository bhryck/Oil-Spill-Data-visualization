...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-20032215.308130, -1544447.090780, 19586880.987903, 18537904.429117], maxZoom: 28, minZoom: 3
    })
});


map.getView().fit([-20032215.308130, -1544447.090780, 19586880.987903, 18537904.429117], map.getSize());
